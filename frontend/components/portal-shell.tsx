...
const candidateItems = [
  ...
  { href: "/candidate/interviews/ai", label: "Interviews", icon: MessageSquare },
...
const adminItems = [
  ...
  { href: "/admin/interviews", label: "Interview Setup", icon: CalendarDays },
  { href: "/admin/interviews/ai", label: "Schedule Interview", icon: MessageSquare },
